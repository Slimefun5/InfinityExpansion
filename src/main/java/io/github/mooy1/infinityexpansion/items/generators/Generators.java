...
public final class Generators {
    ...
    public static final SlimefunItemStack INFINITY_REACTOR = new SlimefunItemStack("INFINITY_REACTOR", MaterialCompat.safe(XMaterial.BEACON));
    public static final SlimefunItemStack HYDRO = new SlimefunItemStack("HYDRO_GENERATOR", MaterialCompat.safe(XMaterial.PRISMARINE_WALL));
    public static final SlimefunItemStack REINFORCED_HYDRO = new SlimefunItemStack("REINFORCED_HYDRO_GENERATOR", MaterialCompat.safe(XMaterial.END_STONE_BRICK_WALL));
    public static final SlimefunItemStack GEOTHERMAL = new SlimefunItemStack("GEOTHERMAL_GENERATOR", MaterialCompat.safe(XMaterial.MAGMA_BLOCK));
    public static final SlimefunItemStack REINFORCED_GEOTHERMAL = new SlimefunItemStack("REINFORCED_GEOTHERMAL_GENERATOR", MaterialCompat.safe(XMaterial.SHROOMLIGHT));
    public static final SlimefunItemStack BASIC_PANEL = new SlimefunItemStack("BASIC_PANEL", MaterialCompat.safe(XMaterial.BLUE_GLAZED_TERRACOTTA));
    public static final SlimefunItemStack ADVANCED_PANEL = new SlimefunItemStack("ADVANCED_PANEL", MaterialCompat.safe(XMaterial.RED_GLAZED_TERRACOTTA));
    public static final SlimefunItemStack CELESTIAL_PANEL = new SlimefunItemStack("CELESTIAL_PANEL", MaterialCompat.safe(XMaterial.YELLOW_GLAZED_TERRACOTTA));
    public static final SlimefunItemStack VOID_PANEL = new SlimefunItemStack("VOID_PANEL", MaterialCompat.safe(XMaterial.LIGHT_GRAY_GLAZED_TERRACOTTA));
    public static final SlimefunItemStack INFINITE_PANEL = new SlimefunItemStack("INFINITE_PANEL", MaterialCompat.safe(XMaterial.LIGHT_BLUE_GLAZED_TERRACOTTA));
